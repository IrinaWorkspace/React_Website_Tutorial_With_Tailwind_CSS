  ...
  return (
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded relative">
        {/* Overlay */}
        <div className="absolute w-full h-full bg-black/70 rounded text-white ps-2">
          <p className="font-bold text-2xl px-2 pt-4">Sun's Out, BOGO's Out</p>
          <p className="px-2">Through 8/26</p>
          <button className="border-white bg-white text-black mx-2 absolute bottom-4 hover:bg-orange-500 hover:text-black hover:border-orange-500">
            Order Now
          </button>
        </div>
        <img
